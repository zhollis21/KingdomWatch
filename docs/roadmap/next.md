...
The earliest milestone with open work is **M1 — Headless sim**, followed by **M2 — Stress test**. Issues from other milestones that these wait on appear as dashed stubs; what they unblock is in the tables. Bold outline = ready.
